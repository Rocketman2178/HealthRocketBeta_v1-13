...
export function ContestLibrary({ 
  ...
  const [upcomingContests, setUpcomingContests] = React.useState<Challenge[]>(contestChallenges);
  ...
  React.useEffect(() => {
    const fetchUpcomingContests = async () => {
      try {
        ...
        // First add all contest challenges
              ...
              <div className="space-y-3">
                {upcomingContests.map(contest => (
                  <div
                    ...
                    className="bg-orange-500/10 rounded-lg overflow-hidden cursor-pointer hover:bg-orange-500/20 transition-colors border border-orange-500/20"
                  >
